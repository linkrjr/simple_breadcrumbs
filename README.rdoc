...
Add method:	
	...
	:options={} => 	The same list of options that can be passed to a before_filter, 
					view http://api.rubyonrails.org/classes/ActionController/Filters/ClassMethods.html#M000526 for more details
